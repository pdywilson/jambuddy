CindyJS.registerPlugin(1, "rnn2", function(api) {
    ...
    async function getMelody(inputmelody, chords, bars, cdycallback) {
    ...
    api.defineFunction("continueSequence", 4, function(args, modifs) {
        ...
        let bars = unwrap(api.evaluate(args[2]));
        console.log('bars',bars);
        console.log('chords',chords);

        getMelody(inputmelody, chords, bars, cloneExpression(args[3]));
        return api.nada;
    });
});
